...
public class TiqueteMultipleDeluxe {
	 ...
	 private String mercancia_extra;
	 private boolean esTransferible;
	
	 private MultiEvento multiEvento;
	
	 public TiqueteMultipleDeluxe(int precio, double cargo_porcentual_servicio, double cuota_fija,
	                              Date fecha, int hora, String identificador,
	                              String mercancia_extra, boolean esTransferible, MultiEvento multiEvento) {
	     this.precio = precio;
	     ...
	     this.mercancia_extra = mercancia_extra;
	...
	public String getMercancia_extra() {
		return mercancia_extra;
	}
	
	public void setMercancia_extra(String mercancia_extra) {
		this.mercancia_extra = mercancia_extra;
	}
